...
function displayWeatherInfo(weatherData) {
  ...
  rightColumn.innerHTML = `
    <p class="info"><i class="icon eye"></i> Visibility: <span class="value">${
      weatherData.visibility
    } meters</span></p>
    <p class="info"><i class="icon sun"></i> Sunrise: <span class="value">${new Date(
      weatherData.sys.sunrise * 1000
    ).toLocaleTimeString()}</span></p>
    <p class="info"><i class="icon sun"></i> Sunset: <span class="value">${new Date(
      weatherData.sys.sunset * 1000
    ).toLocaleTimeString()}</span></p>
    <p class="info"><i class="icon cloud"></i> Cloudiness: <span class="value">${
